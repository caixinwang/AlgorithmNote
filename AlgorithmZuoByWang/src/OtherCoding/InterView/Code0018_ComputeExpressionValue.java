...
// 返回分数
public class Code0018_ComputeExpressionValue {
	...
	public static int sores2(String s) {
		char[] str=s.toCharArray();
		Stack<Integer> stack=new Stack<>();
		stack.push(1);//事先放一个1进去
		for (char c:str){
			if (c=='(') {
				stack.push(1);
			} else{
	...
	public static void main(String[] args) {
		...
		System.out.println(sores2(str1));
		...
		System.out.println(sores2(str2));
		...
		System.out.println(sores2(str3));
	}
