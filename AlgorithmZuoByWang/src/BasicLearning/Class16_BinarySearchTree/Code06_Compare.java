...
import BasicLearning.Class16_BinarySearchTree.Code02_AVLTreeMap.AVLTreeMap;
import BasicLearning.Class16_BinarySearchTree.Code03_SizeBalancedTreeMap.SizeBalancedTreeMap;
import BasicLearning.Class16_BinarySearchTree.Code04_SkipListMap.SkipListMap;

import java.util.TreeMap;

// 本文件为avl、sbt、skiplist三种结构的测试文件
public class Code06_Compare {
