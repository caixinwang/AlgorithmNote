...
dp定位从0~i还是从i~N-1，取决你的题目从左往右试舒服还是从右往左试舒服。从左往右试，跟从右往左试，其实没有太大的区别，它可能决定你在列可能性的时候的一个方向，但是策略应该是差不多的。这道题我们为什么决定从从左往右试，因为星号它是跟前面字符的星号，它不是跟后面字符的，所以可能从前往后试，会比较舒适一点。
