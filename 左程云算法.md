...
- 可以不用递归来做。我们可以不直接建立4N的空间，这样做太没脑子。我们可以聪明一点，因为每次我们都是要建立出一个满二叉树，根据上面的总结，结点的个数最多为<img src="image/image-20221113234234304.png" alt="image-20221113234234304" style="zoom:50%;" />，并且废弃掉0下标，我们可以直接建立一个<img src="image/image-20221113234236077.png" alt="image-20221113234236077" style="zoom:50%;" />大小的数组即可。这样一来我们直接倒着填充这个数组，从最后一个下标开始填，如果不存在就填0，把最后一层的填完之后就可以自底向上迭代的填好这个数组了。
...
![image-20221113234823352](image/image-20221113234823352.png)
...
![image-20221113234512990](image/image-20221113234512990.png)
...
![image-20221113234530436](image/image-20221113234530436.png)
